...
for (s in 1:length(species)){
	...
	if ( (length(which(!is.na(dat$Abundance))) > th) & (length(which(dat$Abundance[!is.na(dat$Abundance)] > 0)) > 0) ){ #greater than th non-missing abundance values, at least one non-zero
		...
		if (length(unique(dat$log.Abundance[which(!is.na(dat$log.Abundance))]))==1){ #abundances are all = 1
			...
			png(paste0('./plots/MattersArising/m4_avg/KonzaGrasshoppers/',species[s],'.png'))
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Konza_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Konza_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Konza_GallInsects_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Konza_GallInsects_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/CedarCreek/grasshoppers/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/CedarCreek_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/CedarCreek_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/CedarCreek/sweep1/',s,'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/CedarCreek_Sweep1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/CedarCreek_Sweep1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/CedarCreek/sweep2/',s,'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/CedarCreek_Sweep2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/CedarCreek_Sweep2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Phoenix/sweep/',s,'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Phoenix_Sweep_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Phoenix_Sweep_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#				png(paste0('./plots/MattersArising/Phoenix/pitfall1/',s,'.png'))
#				plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#				abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#				dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Phoenix_Pitfall1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Phoenix_Pitfall1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Phoenix/pitfall2/',s,'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Phoenix_Pitfall2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Phoenix_Pitfall2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HarvardForest/ants1/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/HarvardForest_Ants1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/HarvardForest_Ants1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HarvardForest/ants.Nantucket/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/HarvardForest_AntsNantucket_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/HarvardForest_AntsNantucket_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HarvardForest/ticks/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/HarvardForest_Ticks_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/HarvardForest_Ticks_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HubbardBrook/lepidoptera1/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/HubbardBrook_Lep1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/HubbardBrook_Lep1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HubbardBrook/lepidoptera2/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/HubbardBrook_Lep2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/HubbardBrook_Lep2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/NorthTemperateLakes/PelagicMacroinvertebrates/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/NorthTemperateLakes_Pelagic_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/NorthTemperateLakes_Pelagic_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/NorthTemperateLakes/BenthicMacroinvertebrates/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/NorthTemperateLakes_Benthic_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/NorthTemperateLakes_Benthic_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/NorthTemperateLakes/Crayfish1/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/NorthTemperateLakes_Crayfish1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/NorthTemperateLakes_Crayfish1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/NorthTemperateLakes/Crayfish2/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/NorthTemperateLakes_Crayfish2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/NorthTemperateLakes_Crayfish2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Sevilleta/grasshoppers/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Sevilleta_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Sevilleta_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Sevilleta/pitfall/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,'./summary_tables/MattersArising/m4_avg/Sevilleta_Pitfall_trends.txt',sep='\t',quote=F,row.names=F)
write.table(out,'./summary_tables/MattersArising/m4_avg/Sevilleta_Pitfall_abundance.txt',sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Arctic/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Arctic_StreamInsects_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Arctic_StreamInsects_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Baltimore/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Baltimore_Mosquitoes_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Baltimore_Mosquitoes_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/BonanzaCreek/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/BonanzaCreek_BarkBeetles_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/BonanzaCreek_BarkBeetles_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/BonanzaCreek_Leafminers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/BonanzaCreek_Leafminers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Coweeta/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Coweeta_StreamInvertebrates_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Coweeta_StreamInvertebrates_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/GeorgiaCoastal/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/GeorgiaCoastal_BurrowingCrabs_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/GeorgiaCoastal_BurrowingCrabs_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/GeorgiaCoastal_FiddlerCrabs_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/GeorgiaCoastal_FiddlerCrabs_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/GeorgiaCoastal_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/GeorgiaCoastal_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/GeorgiaCoastal_Invertebrates_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/GeorgiaCoastal_Invertebrates_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Midwest/',species[s],'.png'))
#					plot(t.scale,Z,main=species[s],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4_avg/Midwest_Aphids_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4_avg/Midwest_Aphids_abundance.txt'),sep='\t',quote=F,row.names=F)


######################################################################################################
# Compile all trends into a single dataframe

files = list.files(paste0('./summary_tables/MattersArising/m4_avg'),full.names=T)
...
write.table(trends,'./summary_tables/MattersArising/m4_avg/time_trends_arthropods_m4_wDatasetNames.txt',sep='\t',row.names=F,quote=F)
...
write.table(trends2,'./summary_tables/MattersArising/m4_avg/time_trends_arthropods_m4.txt',sep='\t',row.names=F,quote=F)
...
write.table(abundances,'./summary_tables/MattersArising/m4_avg/PerSpecies_Abundance_LTER_m4.txt',sep='\t',row.names=F,quote=F)


######################################################################################################
# Mean & 95% CI

dat = read.table(paste0('./summary_tables/MattersArising/m4_avg/time_trends_arthropods_m4.txt'),sep='\t',as.is=T,check.names=F,header=T)
...
png(paste0('./plots/MattersArising/m4_avg/t-test_abundance_lters_barplot_Species.png'),width=200,height=500)
...
dp2 = ggplot(dat, aes(x=LTER.Dataset, y=Abundance.trend, fill=Habitat)) + 
	...
	ggsave(filename='./plots/MattersArising/m4_avg/ALL_time_trends_boxplot_relaxed_noannotations_violin_Species.png',plot=dp2,dpi=600,unit='cm',height=8,width=24)
...
data1 = read.table('./summary_tables/MattersArising/m4_avg/PerSpecies_Abundance_LTER_m4.txt',sep='\t',as.is=T,check.names=F,header=T)
	...
	if (nrow(dat)<4){ #skip time series with < 4 data points
		...
		for (v in 1:length(vars)){
			...
			if (length(log.vals)<4){
				...
				png(paste0('./plots/MattersArising/m4_avg/diversity/',vars[v],'_',datasets[i],'.png'))
...
write.table(trends,'./summary_tables/MattersArising/m4_avg/arthropod_diversity_trends_m4.txt',sep='\t',quote=F,row.names=F)


# Boxplots of trends
trends = read.table('./summary_tables/MattersArising/m4_avg/arthropod_diversity_trends_m4.txt',sep='\t',as.is=T,check.names=F,header=T)
...
png('./plots/MattersArising/m4_avg/diversity_trends_boxplot_m4.png',res=300,width=480*2.5,height=480*4)
...
png(paste0('./plots/MattersArising/m4_avg/t-test_diversity_richness.png'),width=200,height=450)
par(cex.lab=2,cex.axis=1.5,oma=c(0,0,0,0),mar=c(15,8,2,2),lwd=2)
...
dev.off()
png(paste0('./plots/MattersArising/m4_avg/t-test_diversity_evenness.png'),width=200,height=450)
par(cex.lab=2,cex.axis=1.5,oma=c(0,0,0,0),mar=c(15,8,2,2),lwd=2)
...
segments(bars,lowers,bars,uppers,lwd=2); arrows(bars,lowers,bars,uppers,lwd=2,angle=90,code=3,length=(par("usr")[2]-par("usr")[1])/4)
dev.off()
png(paste0('./plots/MattersArising/m4_avg/t-test_diversity_Jaccard.png'),width=200,height=450)
par(cex.lab=2,cex.axis=1.5,oma=c(0,0,0,0),mar=c(15,8,2,2),lwd=2)
