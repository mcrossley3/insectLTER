...
wsd = unique(data1$WATERSHED)
#only analyze watersheds included in Welti et al. 2020 PNAS: ungrazed watershed codes: 1D, SpB, 2C, 2D, 4D, 4F, 20B; grazed watershed codes: N1A, N1B, N4A, N4D, N20A, and N20B
	...
	for (l in 1:length(locales)){
		...
		if ( (length(which(!is.na(dat2$Abundance))) > th) & (length(which(dat2$Abundance[!is.na(dat2$Abundance)] > 0)) > 0) ){ #greater than th non-missing abundance values, at least one non-zero
			...
			if (length(unique(dat2$log.Abundance[which(!is.na(dat2$log.Abundance))]))==1){ #abundances are all = 1
				...
				png(paste0('./plots/MattersArising/m4/KonzaGrasshoppers/',locales[l],' ',species[s],'.png'))
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Konza_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Konza_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#				png(paste0('./plots/MattersArising/Konza/galls/',locales[l],'.png'))
#				plot(t.scale,Z,main=locales[l],xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#				abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#				dev.off()
		}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Konza_GallInsects_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Konza_GallInsects_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/CedarCreek/grasshoppers/',species[s],'_',locales[l],'.png'))
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/CedarCreek_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/CedarCreek_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/CedarCreek/sweep1/',s,'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/CedarCreek_Sweep1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/CedarCreek_Sweep1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/CedarCreek/sweep2/',s,'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/CedarCreek_Sweep2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/CedarCreek_Sweep2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Phoenix/sweep/',s,'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Phoenix_Sweep_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Phoenix_Sweep_abundance.txt'),sep='\t',quote=F,row.names=F)
...
tx = 1
for (s in 1:length(species)){
	dat = out2[which(out2$Species.code==species[s]),]
	locales = sort(unique(dat$Locale))
	for (l in 1:length(locales)){
		dat2 = dat[which(dat$Locale==locales[l]),]
		if ( (length(which(!is.na(dat2$Abundance))) > th) & (length(which(dat2$Abundance[!is.na(dat2$Abundance)] > 0)) > 0) ){ #greater than 3 non-missing abundance values, at least one non-zero
...
#				png(paste0('./plots/MattersArising/Phoenix/pitfall1/',s,'_',locales[l],'.png'))
#				plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#				abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#				dev.off()
			}
...
write.table(trends2,paste0('./summary_tables/MattersArising/m4/Phoenix_Pitfall1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out2,paste0('./summary_tables/MattersArising/m4/Phoenix_Pitfall1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Phoenix/pitfall2/',s,'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Phoenix_Pitfall2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Phoenix_Pitfall2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HarvardForest/ants1/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/HarvardForest_Ants1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/HarvardForest_Ants1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HarvardForest/ants.Nantucket/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/HarvardForest_AntsNantucket_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/HarvardForest_AntsNantucket_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HarvardForest/ticks/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/HarvardForest_Ticks_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/HarvardForest_Ticks_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HubbardBrook/lepidoptera1/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/HubbardBrook_Lep1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/HubbardBrook_Lep1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/HubbardBrook/lepidoptera2/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/HubbardBrook_Lep2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/HubbardBrook_Lep2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/NorthTemperateLakes/PelagicMacroinvertebrates/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/NorthTemperateLakes_Pelagic_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/NorthTemperateLakes_Pelagic_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/NorthTemperateLakes/BenthicMacroinvertebrates/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/NorthTemperateLakes_Benthic_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/NorthTemperateLakes_Benthic_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/NorthTemperateLakes/Crayfish1/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/NorthTemperateLakes_Crayfish1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/NorthTemperateLakes_Crayfish1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/NorthTemperateLakes/Crayfish2/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/NorthTemperateLakes_Crayfish2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/NorthTemperateLakes_Crayfish2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Sevilleta/grasshoppers/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Sevilleta_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Sevilleta_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Sevilleta/pitfall/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Sevilleta_Pitfall_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Sevilleta_Pitfall_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Arctic/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Arctic_StreamInsects_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Arctic_StreamInsects_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Baltimore/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Baltimore_Mosquitoes_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Baltimore_Mosquitoes_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/BonanzaCreek/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/BonanzaCreek_BarkBeetles_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/BonanzaCreek_BarkBeetles_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/BonanzaCreek_Leafminers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/BonanzaCreek_Leafminers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Coweeta/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Coweeta_StreamInvertebrates_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Coweeta_StreamInvertebrates_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/GeorgiaCoastal/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/GeorgiaCoastal_BurrowingCrabs_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/GeorgiaCoastal_BurrowingCrabs_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/GeorgiaCoastal_FiddlerCrabs_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/GeorgiaCoastal_FiddlerCrabs_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/GeorgiaCoastal_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/GeorgiaCoastal_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/GeorgiaCoastal_Invertebrates_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/GeorgiaCoastal_Invertebrates_abundance.txt'),sep='\t',quote=F,row.names=F)
...
#					png(paste0('./plots/MattersArising/Midwest/',species[s],'_',locales[l],'.png'))
#					plot(t.scale,Z,main=paste0(species[s],' ',locales[l]),xlab='Scaled time',ylab='Z-transformed abundance',lwd=2,cex=2,pch=16)
#					abline(a=arr.Z$coef[1],b=abundance.trend,lty=2,col='red',lwd=1.5)
#					dev.off()
			}
...
write.table(trends,paste0('./summary_tables/MattersArising/m4/Midwest_Aphids_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/MattersArising/m4/Midwest_Aphids_abundance.txt'),sep='\t',quote=F,row.names=F)


######################################################################################################
# Compile all trends into a single dataframe

files = list.files(paste0('./summary_tables/MattersArising/m4'),full.names=T)
...
write.table(trends,'./summary_tables/MattersArising/m4/time_trends_arthropods_m4_wDatasetNames.txt',sep='\t',row.names=F,quote=F)
...
write.table(trends,'./summary_tables/MattersArising/m4/time_trends_arthropods_m4.txt',sep='\t',row.names=F,quote=F)
...
write.table(abundances,'./summary_tables/MattersArising/m4/PerSpecies_Abundance_LTER_m4.txt',sep='\t',row.names=F,quote=F)


######################################################################################################
# Mean & 95% CI

dat = read.table(paste0('./summary_tables/MattersArising/m4/time_trends_arthropods_m4.txt'),sep='\t',as.is=T,check.names=F,header=T)
...
png(paste0('./plots/MattersArising/m4/t-test_abundance_lters_barplot_Species.png'),width=200,height=500)
...
dp2 = ggplot(dat2, aes(x=LTER.Dataset, y=Species.mean.trend, fill=Habitat)) + 
	...
	ggsave(filename='./plots/MattersArising/m4/ALL_time_trends_boxplot_relaxed_noannotations_violin_Species.png',plot=dp2,dpi=600,unit='cm',height=8,width=24)
...
data1 = read.table('./summary_tables/MattersArising/m4/PerSpecies_Abundance_LTER_m4.txt',sep='\t',as.is=T,check.names=F,header=T)
...
data2$Abundance[which(data2$LTER.site=='Phoenix' & data2$Dataset=='Sweep')] = data2$Abundance[which(data2$LTER.site=='Phoenix' & data2$Dataset=='Sweep')] * 20 #transform insects/sweep into insects/20 sweeps to improve rarefaction
...
out$minsamp = out$P10
out$minsamp[which(out$LTER.Dataset=='Baltimore_Mosquitoes')] = out$P20[which(out$LTER.Dataset=='Baltimore_Mosquitoes')] #use quantile=0.2 because quantile=0.1 gives a rarefaction sample < 2
out$minsamp[which(out$LTER.Dataset=='HarvardForest_Ants1')] = out$P20[which(out$LTER.Dataset=='HarvardForest_Ants1')] #use quantile=0.2 because quantile=0.1 gives a rarefaction sample < 2
	...
	if (nrow(dat)<4){ #skip time series with < 4 data points
		...
		for (v in 1:length(vars)){
			...
			if (length(log.vals)<4){
				...
				png(paste0('./plots/MattersArising/m4/diversity/',vars[v],'_',datasets[i],'.png'))
...
trends$Jaccard.trend[which(trends$Jaccard.trend==-999)] = NA
write.table(trends,'./summary_tables/MattersArising/m4/arthropod_diversity_trends_m4.txt',sep='\t',quote=F,row.names=F)


# Boxplots of trends
trends = read.table('./summary_tables/MattersArising/m4/arthropod_diversity_trends_m4.txt',sep='\t',as.is=T,check.names=F,header=T)
...
png('./plots/MattersArising/m4/diversity_trends_boxplot_m4.png',res=300,width=480*2.5,height=480*4)
...
png(paste0('./plots/MattersArising/m4/t-test_diversity_richness.png'),width=200,height=450)
par(cex.lab=2,cex.axis=1.5,oma=c(0,0,0,0),mar=c(15,8,2,2),lwd=2)
...
dev.off()
png(paste0('./plots/MattersArising/m4/t-test_diversity_evenness.png'),width=200,height=450)
par(cex.lab=2,cex.axis=1.5,oma=c(0,0,0,0),mar=c(15,8,2,2),lwd=2)
...
segments(bars,lowers,bars,uppers,lwd=2); arrows(bars,lowers,bars,uppers,lwd=2,angle=90,code=3,length=(par("usr")[2]-par("usr")[1])/4)
dev.off()
png(paste0('./plots/MattersArising/m4/t-test_diversity_Jaccard.png'),width=200,height=450)
par(cex.lab=2,cex.axis=1.5,oma=c(0,0,0,0),mar=c(15,8,2,2),lwd=2)
