	...
	for (l in 1:length(locales)){
		...
		if ( (length(which(!is.na(dat2$Abundance))) > th) & (length(which(dat2$Abundance[!is.na(dat2$Abundance)] > 0)) > 0) ){ #greater than th non-missing abundance values, at least one non-zero
			...
			if (length(unique(dat2$log.Abundance[which(!is.na(dat2$log.Abundance))]))==1){ #abundances are all = 1
				...
				png(paste0('./plots/m4_standard_subsite/KonzaGrasshoppers/',locales[l],' ',species[s],'.png'))
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Konza_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Konza_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Konza_GallInsects_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Konza_GallInsects_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/CedarCreek_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/CedarCreek_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/CedarCreek_Sweep1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/CedarCreek_Sweep1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/CedarCreek_Sweep2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/CedarCreek_Sweep2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Phoenix_Sweep_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Phoenix_Sweep_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends2,paste0('./summary_tables/m4_standard_subsite/Phoenix_Pitfall1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out2,paste0('./summary_tables/m4_standard_subsite/Phoenix_Pitfall1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Phoenix_Pitfall2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Phoenix_Pitfall2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/HarvardForest_Ants1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/HarvardForest_Ants1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/HarvardForest_AntsNantucket_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/HarvardForest_AntsNantucket_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/HarvardForest_Ticks_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/HarvardForest_Ticks_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/HubbardBrook_Lep1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/HubbardBrook_Lep1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/HubbardBrook_Lep2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/HubbardBrook_Lep2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/NorthTemperateLakes_Pelagic_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/NorthTemperateLakes_Pelagic_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/NorthTemperateLakes_Benthic_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/NorthTemperateLakes_Benthic_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/NorthTemperateLakes_Crayfish1_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/NorthTemperateLakes_Crayfish1_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/NorthTemperateLakes_Crayfish2_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/NorthTemperateLakes_Crayfish2_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Sevilleta_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Sevilleta_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Sevilleta_Pitfall_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Sevilleta_Pitfall_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Arctic_StreamInsects_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Arctic_StreamInsects_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Baltimore_Mosquitoes_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Baltimore_Mosquitoes_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/BonanzaCreek_BarkBeetles_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/BonanzaCreek_BarkBeetles_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/BonanzaCreek_Leafminers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/BonanzaCreek_Leafminers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Coweeta_StreamInvertebrates_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Coweeta_StreamInvertebrates_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/GeorgiaCoastal_BurrowingCrabs_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/GeorgiaCoastal_BurrowingCrabs_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/GeorgiaCoastal_FiddlerCrabs_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/GeorgiaCoastal_FiddlerCrabs_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/GeorgiaCoastal_Grasshoppers_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/GeorgiaCoastal_Grasshoppers_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/GeorgiaCoastal_Invertebrates_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/GeorgiaCoastal_Invertebrates_abundance.txt'),sep='\t',quote=F,row.names=F)
...
write.table(trends,paste0('./summary_tables/m4_standard_subsite/Midwest_Aphids_trends.txt'),sep='\t',quote=F,row.names=F)
write.table(out,paste0('./summary_tables/m4_standard_subsite/Midwest_Aphids_abundance.txt'),sep='\t',quote=F,row.names=F)


######################################################################################################
# Compile all trends into a single dataframe

files = list.files(paste0('./summary_tables/m4'),full.names=T)
...
write.table(trends,'./summary_tables/m4_standard_subsite/time_trends_arthropods_m4_wDatasetNames_standard_subsite.txt',sep='\t',row.names=F,quote=F)
...
write.table(trends,'./summary_tables/m4_standard_subsite/time_trends_arthropods_m4_standard_subsite.txt',sep='\t',row.names=F,quote=F)
...
write.table(abundances,'./summary_tables/m4_standard_subsite/PerSpecies_Abundance_LTER_m4_standard_subsite.txt',sep='\t',row.names=F,quote=F)


######################################################################################################
# Mean & 95% CI

dat = read.table(paste0('./summary_tables/m4_standard_subsite/time_trends_arthropods_m4_standard_subsite.txt'),sep='\t',as.is=T,check.names=F,header=T)
...
png(paste0('./plots/m4_standard_subsite/t-test_abundance_lters_barplot_Species.png'),width=200,height=500)
...
dp2 = ggplot(dat2, aes(x=LTER.Dataset, y=Species.mean.trend, fill=Habitat)) + 
	...
	ggsave(filename='./plots/m4_standard_subsite/ALL_time_trends_boxplot_relaxed_noannotations_violin_Species.png',plot=dp2,dpi=600,unit='cm',height=8,width=24)
...
data1 = read.table('./summary_tables/m4_standard_subsite/PerSpecies_Abundance_LTER_m4.txt',sep='\t',as.is=T,check.names=F,header=T)
...
data1 = read.table('./summary_tables/m4_standard_subsite/PerSpecies_Abundance_LTER_m4_standard_subsite.txt',sep='\t',as.is=T,check.names=F,header=T)
	...
	if (nrow(dat)<4){ #skip time series with < 4 data points
		...
		for (v in 1:length(vars)){
			...
			if (length(log.vals)<4){
				...
				png(paste0('./plots/m4_standard_subsite/diversity/',vars[v],'_',datasets[i],'.png'))
...
write.table(trends,'./summary_tables/m4_standard_subsite/arthropod_diversity_trends_m4_standard_subsite.txt',sep='\t',quote=F,row.names=F)


# Boxplots of trends
trends = read.table('./summary_tables/m4_standard_subsite/arthropod_diversity_trends_m4.txt',sep='\t',as.is=T,check.names=F,header=T)
...
png('./plots/m4_standard_subsite/diversity_trends_boxplot_m4.png',res=300,width=480*2.5,height=480*4)
...
png(paste0('./plots/m4_standard_subsite/t-test_diversity_richness.png'),width=200,height=450)
par(cex.lab=2,cex.axis=1.5,oma=c(0,0,0,0),mar=c(15,8,2,2),lwd=2)
...
dev.off()
png(paste0('./plots/m4_standard_subsite/t-test_diversity_evenness.png'),width=200,height=450)
par(cex.lab=2,cex.axis=1.5,oma=c(0,0,0,0),mar=c(15,8,2,2),lwd=2)
...
segments(bars,lowers,bars,uppers,lwd=2); arrows(bars,lowers,bars,uppers,lwd=2,angle=90,code=3,length=(par("usr")[2]-par("usr")[1])/4)
dev.off()
png(paste0('./plots/m4_standard_subsite/t-test_diversity_Jaccard.png'),width=200,height=450)
par(cex.lab=2,cex.axis=1.5,oma=c(0,0,0,0),mar=c(15,8,2,2),lwd=2)
